...
- **DNA-Sequence**: Designed and implemented a Decision Tree model to classify DNA sequence boundaries, achieving a robust accuracy of 91% on a defined dataset.
